...
namespace FiltradoYReconocimiento
{
    class ClasificacionFiguras
    {
        ...
        public Bitmap ProcesarImagen(Bitmap mapaBits)
        {
            ...
            Pen plumaAmarilla = new Pen(Color.Yellow, 2); // Circulo
            Pen plumaRoja = new Pen(Color.Red, 2);       // Cuadrilatero
            Pen plumaCafe = new Pen(Color.Brown, 2);   // Cuadrilatero
            Pen plumaVerde = new Pen(Color.Green, 2);   // Triangulo
            Pen plumaAzul = new Pen(Color.Blue, 2);     // Triangulo
